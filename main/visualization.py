...
def plot_sorted_department_metrics(df):
    ...
    satisfaction_sorted = (
        df.groupby("department")["satisfaction_level"]
        .mean()
        .sort_values(ascending=False)
    )
    monthly_hours_sorted = (
        df.groupby("department")["average_monthly_hours"]
        .mean()
        .sort_values(ascending=False)
    )
    last_evaluation_sorted = (
        df.groupby("department")["last_evaluation"].mean().sort_values(ascending=False)
    )
    time_spent_sorted = (
        df.groupby("department")["time_spend_company"]
        .mean()
        .sort_values(ascending=False)
    )
    ...
    sns.barplot(
        x=satisfaction_sorted.index,
        y=satisfaction_sorted.values,
        palette="Blues_d",
        ax=ax,
    )
    ...
    sns.barplot(
        x=monthly_hours_sorted.index,
        y=monthly_hours_sorted.values,
        palette="Reds_d",
        ax=ax,
    )
    ...
    sns.barplot(
        x=last_evaluation_sorted.index,
        y=last_evaluation_sorted.values,
        palette="Greens_d",
        ax=ax,
    )
    ...
    sns.barplot(
        x=time_spent_sorted.index,
        y=time_spent_sorted.values,
        palette="Purples_d",
        ax=ax,
    )
...
def plot_pie_charts_for_left(df):
    ...
    axs[0].pie(
        salary_left_percentage_total,
        labels=salary_left_percentage_total.index,
        autopct="%1.1f%%",
        startangle=90,
        colors=sns.color_palette("Reds", len(salary_left_percentage_total)),
        textprops={"fontsize": 12, "fontweight": "bold"},
    )
    axs[0].set_title(
        "Proportion of Employees Left by Salary Category",
        fontsize=14,
        fontweight="bold",
    )
    ...
    axs[1].pie(
        department_left_percentage_total,
        labels=department_left_percentage_total.index,
        autopct="%1.1f%%",
        startangle=90,
        colors=sns.color_palette("Blues", len(department_left_percentage_total)),
        textprops={"fontsize": 12, "fontweight": "bold"},
    )
    axs[1].set_title(
        "Proportion of Employees Left by Department", fontsize=14, fontweight="bold"
    )
...
def plot_left_percentages(df):
    ...
    department_left_percentage_sorted = department_left_percentage.sort_values(
        ascending=False
    )
    ...
    bars = axs[0].bar(
        department_left_percentage_sorted.index,
        department_left_percentage_sorted.values,
        color="skyblue",
    )
    axs[0].set_title(
        "Percentage of Employees Left by Department", fontsize=14, fontweight="bold"
    )
    ...
    bars = axs[1].bar(
        salary_left_percentage_sorted.index,
        salary_left_percentage_sorted.values,
        color="salmon",
    )
    axs[1].set_title(
        "Percentage of Employees Left by Salary Category",
        fontsize=14,
        fontweight="bold",
    )
