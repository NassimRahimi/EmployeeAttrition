    ...
    categorical_pipeline = Pipeline(
        [
            (
                "one_hot",
                OneHotEncoder(
                    categories=[department_categories, salary_categories],
                    drop=None,
                    sparse_output=False,
                ),
...
if __name__ == "__main__":
    ...
    pipeline_filename_pickle = (
        f"trained_pipeline_xgb_alldata_noreduction_{current_date}.pkl"
    )
    ...
    categorical_features = [
        "department",
        "salary",
    ]  # Only these two categorical columns
